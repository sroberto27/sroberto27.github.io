/* === LSU Death Valley Experience — Part 1: Utils, reprojection, helpers === */
/* ===========================================================
...
/* -----------------------------------------------------------
   1. Reprojection — REMOVED under MapLibre.
   -----------------------------------------------------------
   The Leaflet build's mercatorToLatLng()/reprojectCoords()/
   reprojectFC() converted EPSG:3857 GeoJSON to EPSG:4326 before
   handing it to Leaflet. MapLibre GL JS consumes GeoJSON sources
   directly in EPSG:4326 (WGS84 lng/lat) and reprojects internally
   for rendering, and every data file in this project (tours.geojson,
   buildings.geojson) is already CRS84/EPSG:4326 — so this whole
   step is dead code here. config.dataCRS is kept for documentation
   only; nothing reads it anymore.
   ----------------------------------------------------------- */
